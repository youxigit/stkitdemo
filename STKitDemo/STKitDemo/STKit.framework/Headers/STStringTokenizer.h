...
/// <mark type=text name="name:systemFont" size="size:16" color="color:black" style="bold/itaic/plain:plain" underline="single:none" strikethrough="single/thick:none">Text</mark>
/// :后面的为 default value.
/// to be continue
