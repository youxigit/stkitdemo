...
- (BOOL) searchBar:(STSearchBar *)searchBar shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text NS_AVAILABLE_IOS(3_0); // called before text changes
...
- (void) searchBarResultsListButtonClicked:(STSearchBar *)searchBar NS_AVAILABLE_IOS(3_2); // called when search results button pressed
