...
/// these are callback functions, do not call this method directly, if you want to custom your refreshcontrol, you should override them to fit different state.
