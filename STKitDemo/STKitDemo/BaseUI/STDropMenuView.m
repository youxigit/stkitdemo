...
- (instancetype) initWithMenuTitles:(NSString *) menuTitle, ... NS_REQUIRES_NIL_TERMINATION {
    ...
    if(self) {
        ...
        STTableView * tableView = [[STTableView alloc] initWithFrame:CGRectMake(0, STOnePixel(), CGRectGetWidth([UIScreen mainScreen].applicationFrame), MIN(height, maxHeight)) style:UITableViewStylePlain];
