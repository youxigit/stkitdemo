...
- (void) setFrame:(CGRect)frame {
    ...
    self.separatorView.frame = CGRectMake(0, CGRectGetHeight(frame) - STOnePixel(), 320, STOnePixel());
}
...
- (instancetype) initWithMenuTitles:(NSString *) menuTitle, ... NS_REQUIRES_NIL_TERMINATION {
    ...
    if(self) {
        ...
        backgroundView.backgroundColor = [UIColor colorWithRGB:0 alpha:1];
        [self addSubview:backgroundView];
        self.backgroundView = backgroundView;
        
        UIView * contentView = [[UIView alloc] initWithFrame:CGRectMake(0, STOnePixel(), 320, MIN(height, maxHeight))];
        ...
        STTableView * tableView = [[STTableView alloc] initWithFrame:self.contentView.bounds style:UITableViewStylePlain];
