...
- (void) reloadMenuItems {
    [self.menuItemViews enumerateObjectsUsingBlock:^(UIView * view, NSUInteger idx, BOOL *stop) {
...
- (void) dismissAnimated:(BOOL) animated {
    ...
    void (^completion)(BOOL) = ^(BOOL finished){
        ...
        [self.menuItemViews enumerateObjectsUsingBlock:^(UIView * obj, NSUInteger idx, BOOL *stop) {
...
- (void)riseAnimation {
    ...
    [self.menuItemViews enumerateObjectsUsingBlock:^(STButton * button, NSUInteger idx, BOOL *stop) {
        ...
        CGPoint fromPosition = CGPointMake(frame.origin.x + STMenuItemImageSize.width / 2.0, frame.origin.y + (rowCount - rowIndex + 2) * 200 + (STMenuItemImageSize.height + 20) / 2 );
...
- (void) dropAnimation {
    ...
    [self.menuItemViews enumerateObjectsUsingBlock:^(UIView * button, NSUInteger idx, BOOL *stop) {
        ...
        NSInteger rowIndex = idx / columnCount;
        NSInteger columnIndex = idx % columnCount;
        CGPoint fromPosition = CGPointMake(frame.origin.x + STMenuItemImageSize.width / 2.0, frame.origin.y + (STMenuItemImageSize.height + 20) / 2.0);
        CGPoint toPosition = CGPointMake(frame.origin.x + STMenuItemImageSize.width / 2.0, frame.origin.y -  (rowIndex + 2)*200 + (STMenuItemImageSize.height + 20) / 2.0);
