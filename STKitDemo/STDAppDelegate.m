...
#define MYPublicDERKey @""

#define MYPublicPEMKey @"-----BEGIN CERTIFICATE-----\
MIICsDCCAhmgAwIBAgIJAO+2jGW3YiA/MA0GCSqGSIb3DQEBBQUAMEUxCzAJBgNV\
BAYTAkFVMRMwEQYDVQQIEwpTb21lLVN0YXRlMSEwHwYDVQQKExhJbnRlcm5ldCBX\
aWRnaXRzIFB0eSBMdGQwHhcNMTQxMDE0MDk0MzU1WhcNMTQxMTEzMDk0MzU1WjBF\
MQswCQYDVQQGEwJBVTETMBEGA1UECBMKU29tZS1TdGF0ZTEhMB8GA1UEChMYSW50\
ZXJuZXQgV2lkZ2l0cyBQdHkgTHRkMIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKB\
gQDHJk2Vck1Tt7CDRe0PzkhXeuo9dOmnxOtrmYnX3Xm8M923AJcuCyHniRfjsYA+\
UN8ozj9+7g+LCaqKOaFLOPcJS1QOGdsy4g761WPThe65n9WrvE5k+zZbHrqWZxzj\
HTTFc6QGZgfpVqJAVe2871TOPa8Ohogob7nbGo8YJEJVgQIDAQABo4GnMIGkMB0G\
A1UdDgQWBBQUxAu6vYTzPdrNOnFjSHkF32sByTB1BgNVHSMEbjBsgBQUxAu6vYTz\
PdrNOnFjSHkF32sByaFJpEcwRTELMAkGA1UEBhMCQVUxEzARBgNVBAgTClNvbWUt\
U3RhdGUxITAfBgNVBAoTGEludGVybmV0IFdpZGdpdHMgUHR5IEx0ZIIJAO+2jGW3\
YiA/MAwGA1UdEwQFMAMBAf8wDQYJKoZIhvcNAQEFBQADgYEAGXg/fSvQV63dPR3d\
U44nDoE/qCe/nsXiIQT1IAeFbm/b8WSxzb8jJLbhfJMvoR0cm3+EKvbuNpnQ/jh4\
XyQ6B/mD1OoI/s/2SwVs46M8ZE61l7hj/3ZBBkHQGcriu4xtSSX4RIrtn1D3dDiG\
+3XMrC908tbZ+Lhl48TyVxTW6IQ=\
-----END CERTIFICATE-----"

#define MYPrivatePEMKey @"-----BEGIN RSA PRIVATE KEY-----\
MIICXQIBAAKBgQDHJk2Vck1Tt7CDRe0PzkhXeuo9dOmnxOtrmYnX3Xm8M923AJcu\
CyHniRfjsYA+UN8ozj9+7g+LCaqKOaFLOPcJS1QOGdsy4g761WPThe65n9WrvE5k\
+zZbHrqWZxzjHTTFc6QGZgfpVqJAVe2871TOPa8Ohogob7nbGo8YJEJVgQIDAQAB\
AoGAeikDxF2WE3mFPDFDpsNp2seaMlKqFXCU3K8VQCYqS4khQuWI1wSbKpUM4235\
dcBT84r4phrPzAEE7L9HMoZh+eloj3bitw8oJXpWfE/kkfz5qIg4xT50lTDA2zEE\
ipGsNlLcAOi2RKO++Z0dVSEBdxgVe99MQqdNk0EJgMHlCCUCQQD/kvb5RAGrjuO3\
8jckJimSq0u12GS6my5wY7yMXCnTk+b1TOAfiFM7wSwNdOkF5QbXCRIN71Ic9kbF\
hYnwaCpvAkEAx3tEGgYnrkmaBNgtFgSJi9VsOIFQX4R805d+MBx4Xu/nA3E6WwIy\
u3UJlZN576xqFK6iXYG3HdNJJc0RMJY3DwJARVAoZyYIhey02bh5N/aZo8uNNv4/\
I1Te3WBPTInaViVwp+p3hlXErRoQxn2EjTK2Di/Jk7nqPSyVuRAkfuzhRQJBAK60\
eWdlXplY4qg9f/cZkDFEgJxYPMD68qwJsL2IIa/b4fH014vfN/lPPk6es5tB4EIu\
1Aqa0Xowko6ls9lepecCQQCXV/G1Pzvhy4m3jrsvt55Im+167/Calty5OFHXJAfq\
cVWg9iUzsmpWrytpSsN/B82M9lYfmyCizmdhJzpjof7g\
-----END RSA PRIVATE KEY-----"
...
- (void) testRSACrypt {
    ...
    NSData * testData = [@"test" UTF8EncodedData];
    STRSACryptor * cryptor = [[STRSACryptor alloc] initWithPublicSecKey:publicKey privateSecKey:privateKey];
    NSData * data = [cryptor signData:testData];
    BOOL verify = [cryptor verifySignature:data signedData:testData];
    NSLog(@"===Verfiy %d ===\n%@",verify, [data base64String]);
    
    NSData * originalData = [@"I am sunjiangting" UTF8EncodedData];
    NSData * publicEnctypeData = [cryptor encryptData:originalData];
    NSData * privateDecryptData = [cryptor decryptData:publicEnctypeData];
    
    NSLog(@"\n%@\n%@\n%@", originalData, publicEnctypeData, privateDecryptData);
}
